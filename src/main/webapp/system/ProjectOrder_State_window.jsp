...
<form action="" method="post"  id="ProjectOrder_State_window">
<div align="center" >
...
$(function(){
	$("#check_btn").click(function(){
		$('#ProjectOrder_State_window').form('submit', {
		    url:'system/alterProjectOrder',	
		    onSubmit: function(){
				// do some check
		    ...
		    success:function(data){
				if(data=="true"){
					//关闭修改弹出框
					$("#OrderCheck_Window").dialog("close");
					//在向服务器改变数据之后，更新前台数据
					$('#ProjectOrder_table').datagrid('reload'); 
					$.messager.show({
						title:'系统信息',
